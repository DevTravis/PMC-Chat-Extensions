...
function doTheme(){
    ...
    if(isClassic){
        ...
        injectStyles('.chat_context #chatBottom > textarea {    background-image: none;    background-color: rgb(44, 62, 80);    color: rgb(236, 240, 241);}.site_btn {    background-image: none;    background-color: #2980b9;}#container {    background-image: none;    background-color: #0F161C;}body {    color: #FFFFFF;}.context-menu-item {    color: #FFFFFF;}.progresstext {    color: rgb(0,0,0);}#level_panel {    color: rgb(0,0,0);}.userSpan.listName:not(.member_moderator):not(.bold){color:rgb(255,255,255)}.time{color:rgb(255,255,255)}#findDialog{color:rgb(0,0,0);}#blacklistDialog{color:rgb(0,0,0);}#reportsDialog{color:rgb(0,0,0);}label{color:rgb(255,255,255);}.channel{color:rgb(255,255,255);}#rule_dialog{color:rgb(0,0,0);}#prefooter{background-image:none; background-color:#0F161C;}.chat_context[data-theme="modern"] .messageList > .messageHolder > .message > .textContainer {background-image:none; background-color:#090E17; border:1px solid #000;}.chat_context[data-theme="modern"] .messageList > .messageHolder > .own-message {color:rgb(0,0,0);}');
